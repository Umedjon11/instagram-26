...
import { DropdownMenuBasic } from "./ellipse";
import { useDispatch } from "react-redux";
import { DeletePost } from "@/reducers/apiProfile";
            ...
            <DialogContent
                ...
                <div className="flex overflow-hidden">
                    ...
                    <div className="w-[420px] h-full text-white flex flex-col border-l border-neutral-800">
                        <div className="flex justify-between items-center gap-3 px-4 py-3 border-b border-neutral-800">
                            ...
                            <DropdownMenuBasic onDelete={handleDelete} />
                        </div>
